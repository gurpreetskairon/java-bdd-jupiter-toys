...
public class CartSteps {
    ...
    @Then("I validate the total amount to be paid")
    public void validateTotalAmount(){
        ...
        Assert.assertEquals("The total amount on the Cart screen is not as expected",
                df.format(expectedTotal), actualTotal);
    }
